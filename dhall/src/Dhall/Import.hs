...
loadWith expr₀ = case expr₀ of
  ...
  NonZeroLit a         -> pure (NonZeroLit a)
  ...
  DateTimeLit a        -> pure (DateTimeLit a)
  ...
  RationalLit a        -> pure (RationalLit a)
  ...
  RationalPercent a b  -> RationalPercent <$> loadWith a <*> loadWith b
  ...
  ListFixedLit b c     -> ListFixedLit <$> loadWith b <*> mapM loadWith c
