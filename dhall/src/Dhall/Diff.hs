...
diffNonZero :: NonZero -> NonZero -> Diff
diffNonZero = diffPrimitive (token . Internal.prettyNonZero)

diffDateTime :: DateTime -> DateTime -> Diff
diffDateTime = diffPrimitive (token . Internal.prettyDateTime)

diffRegex :: Regex -> Regex -> Diff
diffRegex = diffPrimitive (token . Internal.prettyRegex)

diffRational :: Rational -> Rational -> Diff
diffRational = diffPrimitive (token . Internal.prettyRational)
...
skeleton SZ =
    ...
    <>  ignore
skeleton (App SS v) =
  (case Dhall.Normalize.getSSCntExpr v of
    Left e -> "SS"
    Right (NonZeroC n) -> "!!" <> fromString (show (n+1))) <> " "
    <>  ignore
-}
skeleton (SymLit t) =
            lbracket
...
skeleton (App PVoid (Sym t)) =
        "PVoid ^^\"" <> fromString (Data.Text.unpack t) <> "\" "
    <>  ignore
skeleton (App PVoid _) =
        "PVoid "
    <>  ignore
...
skeleton (App List _) =
        "List "
    <>  ignore
--skeleton (App ListFixed _) =
--        "??ListFixed "
--    <>  ignore
skeleton (App (App ListFixed _) _) =
        "ListFixed "
    <>  ignore
skeleton (App {}) =
        ignore
...
diffAnnotatedExpression (ListFixedLit bL cL) (ListFixedLit bR cR) = align doc
  where
    doc =    format " " (diff bL bR)
          <> format " " (diffList cL cR)
...
diffPlusExpression l@(NaturalPlus {}) r@(NaturalPlus {}) =
  ...
  where
    docs (NaturalPlus aL bL) (NaturalPlus aR bR) =
        Data.List.NonEmpty.cons (diffPercentExpression aL aR) (docs bL bR)
    docs aL aR =
        pure (diffPercentExpression aL aR)
diffPlusExpression l@(NaturalPlus {}) r =
    mismatch l r
diffPlusExpression l r@(NaturalPlus {}) =
    mismatch l r
diffPlusExpression l r =
    diffPercentExpression l r

diffPercentExpression :: (Eq a, Pretty a) => Expr Void a -> Expr Void a -> Diff
diffPercentExpression l@(RationalPercent {}) r@(RationalPercent {}) =
    enclosed' "  " (operator "%" <> " ") (docs l r)
  where
    docs (RationalPercent aL bL) (RationalPercent aR bR) =
        Data.List.NonEmpty.cons (diffTextAppendExpression aL aR) (docs bL bR)
    docs aL aR =
        pure (diffTextAppendExpression aL aR)
diffPercentExpression l@(RationalPercent {}) r =
    mismatch l r
diffPercentExpression l r@(RationalPercent {}) =
    mismatch l r
diffPercentExpression l r =
...
diffPrimitiveExpression NonZero NonZero =
    "…"
diffPrimitiveExpression l@NonZero r =
    mismatch l r
diffPrimitiveExpression l r@NonZero =
    mismatch l r
diffPrimitiveExpression NonZeroShow NonZeroShow =
    "…"
diffPrimitiveExpression l@NonZeroShow r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroShow =
    mismatch l r

diffPrimitiveExpression NonZeroClamp NonZeroClamp =
    "…"
diffPrimitiveExpression l@NonZeroClamp r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroClamp =
    mismatch l r

diffPrimitiveExpression NonZeroDiv NonZeroDiv =
    "…"
diffPrimitiveExpression l@NonZeroDiv r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroDiv =
    mismatch l r

diffPrimitiveExpression NonZeroMod NonZeroMod =
    "…"
diffPrimitiveExpression l@NonZeroMod r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroMod =
    mismatch l r

diffPrimitiveExpression NonZeroLog NonZeroLog =
    "…"
diffPrimitiveExpression l@NonZeroLog r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroLog =
    mismatch l r

diffPrimitiveExpression NonZeroAdd NonZeroAdd =
    "…"
diffPrimitiveExpression l@NonZeroAdd r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroAdd =
    mismatch l r

diffPrimitiveExpression NonZeroMultiply NonZeroMultiply =
    "…"
diffPrimitiveExpression l@NonZeroMultiply r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroMultiply =
    mismatch l r

diffPrimitiveExpression NonZeroToNatural NonZeroToNatural =
    "…"
diffPrimitiveExpression l@NonZeroToNatural r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroToNatural =
    mismatch l r

diffPrimitiveExpression NonZeroToInteger NonZeroToInteger =
    "…"
diffPrimitiveExpression l@NonZeroToInteger r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroToInteger =
    mismatch l r

diffPrimitiveExpression NonZeroParse NonZeroParse =
    "…"
diffPrimitiveExpression l@NonZeroParse r =
    mismatch l r
diffPrimitiveExpression l r@NonZeroParse =
    mismatch l r

diffPrimitiveExpression DateTime DateTime =
    "…"
diffPrimitiveExpression l@DateTime r =
    mismatch l r
diffPrimitiveExpression l r@DateTime =
    mismatch l r

diffPrimitiveExpression DateTimeShow DateTimeShow =
    "…"
diffPrimitiveExpression l@DateTimeShow r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeShow =
    mismatch l r

diffPrimitiveExpression DateTimeParse DateTimeParse =
    "…"
diffPrimitiveExpression l@DateTimeParse r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeParse =
    mismatch l r

diffPrimitiveExpression DateTimeFromSeconds DateTimeFromSeconds =
    "…"
diffPrimitiveExpression l@DateTimeFromSeconds r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeFromSeconds =
    mismatch l r

diffPrimitiveExpression DateTimeToSeconds DateTimeToSeconds =
    "…"
diffPrimitiveExpression l@DateTimeToSeconds r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeToSeconds =
    mismatch l r

diffPrimitiveExpression DateTimeAddYears DateTimeAddYears =
    "…"
diffPrimitiveExpression l@DateTimeAddYears r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeAddYears =
    mismatch l r

diffPrimitiveExpression DateTimeAddMonths DateTimeAddMonths =
    "…"
diffPrimitiveExpression l@DateTimeAddMonths r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeAddMonths =
    mismatch l r

diffPrimitiveExpression DateTimeAddDays DateTimeAddDays =
    "…"
diffPrimitiveExpression l@DateTimeAddDays r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeAddDays =
    mismatch l r

diffPrimitiveExpression DateTimeFromWeek DateTimeFromWeek =
    "…"
diffPrimitiveExpression l@DateTimeFromWeek r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeFromWeek =
    mismatch l r

diffPrimitiveExpression DateTimeToWeek DateTimeToWeek =
    "…"
diffPrimitiveExpression l@DateTimeToWeek r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeToWeek =
    mismatch l r

diffPrimitiveExpression DateTimeToDate DateTimeToDate =
    "…"
diffPrimitiveExpression l@DateTimeToDate r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeToDate =
    mismatch l r

diffPrimitiveExpression DateTimeFromDate DateTimeFromDate =
    "…"
diffPrimitiveExpression l@DateTimeFromDate r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeFromDate =
    mismatch l r

diffPrimitiveExpression DateTimeLastDayOfMonth DateTimeLastDayOfMonth =
    "…"
diffPrimitiveExpression l@DateTimeLastDayOfMonth r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeLastDayOfMonth =
    mismatch l r

diffPrimitiveExpression DateTimeGetJulianDay DateTimeGetJulianDay =
    "…"
diffPrimitiveExpression l@DateTimeGetJulianDay r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeGetJulianDay =
    mismatch l r

diffPrimitiveExpression DateTimeSetJulianDay DateTimeSetJulianDay =
    "…"
diffPrimitiveExpression l@DateTimeSetJulianDay r =
    mismatch l r
diffPrimitiveExpression l r@DateTimeSetJulianDay =
    mismatch l r

diffPrimitiveExpression Regex Regex =
    "…"
diffPrimitiveExpression l@Regex r =
    mismatch l r
diffPrimitiveExpression l r@Regex =
    mismatch l r

diffPrimitiveExpression RegexShow RegexShow =
    "…"
diffPrimitiveExpression l@RegexShow r =
    mismatch l r
diffPrimitiveExpression l r@RegexShow =
    mismatch l r

diffPrimitiveExpression RegexMatch RegexMatch =
    "…"
diffPrimitiveExpression l@RegexMatch r =
    mismatch l r
diffPrimitiveExpression l r@RegexMatch =
    mismatch l r

diffPrimitiveExpression RegexScan RegexScan =
    "…"
diffPrimitiveExpression l@RegexScan r =
    mismatch l r
diffPrimitiveExpression l r@RegexScan =
    mismatch l r

diffPrimitiveExpression RegexSplit RegexSplit =
    "…"
diffPrimitiveExpression l@RegexSplit r =
    mismatch l r
diffPrimitiveExpression l r@RegexSplit =
    mismatch l r

diffPrimitiveExpression RegexReplace RegexReplace =
    "…"
diffPrimitiveExpression l@RegexReplace r =
    mismatch l r
diffPrimitiveExpression l r@RegexReplace =
    mismatch l r

diffPrimitiveExpression RegexReplix RegexReplix =
    "…"
diffPrimitiveExpression l@RegexReplix r =
    mismatch l r
diffPrimitiveExpression l r@RegexReplix =
    mismatch l r


diffPrimitiveExpression RegexParse RegexParse =
    "…"
diffPrimitiveExpression l@RegexParse r =
    mismatch l r
diffPrimitiveExpression l r@RegexParse =
    mismatch l r

diffPrimitiveExpression RegexToText RegexToText =
    "…"
diffPrimitiveExpression l@RegexToText r =
    mismatch l r
diffPrimitiveExpression l r@RegexToText =
    mismatch l r


diffPrimitiveExpression Rational Rational =
    "…"
diffPrimitiveExpression l@Rational r =
    mismatch l r
diffPrimitiveExpression l r@Rational =
    mismatch l r

diffPrimitiveExpression RationalShow RationalShow =
    "…"
diffPrimitiveExpression l@RationalShow r =
    mismatch l r
diffPrimitiveExpression l r@RationalShow =
    mismatch l r

diffPrimitiveExpression RationalFromDouble RationalFromDouble =
    "…"
diffPrimitiveExpression l@RationalFromDouble r =
    mismatch l r
diffPrimitiveExpression l r@RationalFromDouble =
    mismatch l r

diffPrimitiveExpression RationalToDouble RationalToDouble =
    "…"
diffPrimitiveExpression l@RationalToDouble r =
    mismatch l r
diffPrimitiveExpression l r@RationalToDouble =
    mismatch l r

diffPrimitiveExpression RationalFromRational RationalFromRational =
    "…"
diffPrimitiveExpression l@RationalFromRational r =
    mismatch l r
diffPrimitiveExpression l r@RationalFromRational =
    mismatch l r

diffPrimitiveExpression RationalParse RationalParse =
    "…"
diffPrimitiveExpression l@RationalParse r =
    mismatch l r
diffPrimitiveExpression l r@RationalParse =
    mismatch l r
...
diffPrimitiveExpression NaturalParse NaturalParse =
    "…"
diffPrimitiveExpression l@NaturalParse r =
    mismatch l r
diffPrimitiveExpression l r@NaturalParse =
    mismatch l r

diffPrimitiveExpression NaturalToBits NaturalToBits =
    "…"
diffPrimitiveExpression l@NaturalToBits r =
    mismatch l r
diffPrimitiveExpression l r@NaturalToBits =
    mismatch l r
...
diffPrimitiveExpression l r@NaturalSubtract =
    mismatch l r
diffPrimitiveExpression NaturalGcd NaturalGcd =
    "…"
diffPrimitiveExpression l@NaturalGcd r =
    mismatch l r
diffPrimitiveExpression l r@NaturalGcd =
    mismatch l r
...
diffPrimitiveExpression IntegerAdd IntegerAdd =
    "…"
diffPrimitiveExpression l@IntegerAdd r =
    mismatch l r
diffPrimitiveExpression l r@IntegerAdd =
    mismatch l r

diffPrimitiveExpression IntegerMultiply IntegerMultiply =
    "…"
diffPrimitiveExpression l@IntegerMultiply r =
    mismatch l r
diffPrimitiveExpression l r@IntegerMultiply =
    mismatch l r

diffPrimitiveExpression IntegerAnd IntegerAnd =
    "…"
diffPrimitiveExpression l@IntegerAnd r =
    mismatch l r
diffPrimitiveExpression l r@IntegerAnd =
    mismatch l r

diffPrimitiveExpression IntegerXor IntegerXor =
    "…"
diffPrimitiveExpression l@IntegerXor r =
    mismatch l r
diffPrimitiveExpression l r@IntegerXor =
    mismatch l r
...
diffPrimitiveExpression IntegerParse IntegerParse =
    "…"
diffPrimitiveExpression l@IntegerParse r =
    mismatch l r
diffPrimitiveExpression l r@IntegerParse =
    mismatch l r
...
diffPrimitiveExpression DoubleParse DoubleParse =
    "…"
diffPrimitiveExpression l@DoubleParse r =
    mismatch l r
diffPrimitiveExpression l r@DoubleParse =
    mismatch l r
...
diffPrimitiveExpression TextToLower TextToLower =
    "…"
diffPrimitiveExpression l@TextToLower r =
    mismatch l r
diffPrimitiveExpression l r@TextToLower =
    mismatch l r

diffPrimitiveExpression TextToUpper TextToUpper =
    "…"
diffPrimitiveExpression l@TextToUpper r =
    mismatch l r
diffPrimitiveExpression l r@TextToUpper =
    mismatch l r

diffPrimitiveExpression TextUnpack TextUnpack =
    "…"
diffPrimitiveExpression l@TextUnpack r =
    mismatch l r
diffPrimitiveExpression l r@TextUnpack =
    mismatch l r

diffPrimitiveExpression TextPack TextPack =
    "…"
diffPrimitiveExpression l@TextPack r =
    mismatch l r
diffPrimitiveExpression l r@TextPack =
    mismatch l r

diffPrimitiveExpression TextToList TextToList =
    "…"
diffPrimitiveExpression l@TextToList r =
    mismatch l r
diffPrimitiveExpression l r@TextToList =
    mismatch l r

diffPrimitiveExpression TextLength TextLength =
    "…"
diffPrimitiveExpression l@TextLength r =
    mismatch l r
diffPrimitiveExpression l r@TextLength =
    mismatch l r

diffPrimitiveExpression TextCompare TextCompare =
    "…"
diffPrimitiveExpression l@TextCompare r =
    mismatch l r
diffPrimitiveExpression l r@TextCompare =
    mismatch l r
...
diffPrimitiveExpression l r@ListReverse =
    mismatch l r
diffPrimitiveExpression ListPermutations ListPermutations =
    "…"
diffPrimitiveExpression l@ListPermutations r =
    mismatch l r
diffPrimitiveExpression l r@ListPermutations =
    mismatch l r

diffPrimitiveExpression ListChoose ListChoose =
    "…"
diffPrimitiveExpression l@ListChoose r =
    mismatch l r
diffPrimitiveExpression l r@ListChoose =
    mismatch l r

diffPrimitiveExpression ListFixed ListFixed =
    "…"
diffPrimitiveExpression l@ListFixed r =
    mismatch l r
diffPrimitiveExpression l r@ListFixed =
    mismatch l r
diffPrimitiveExpression (ListFixedLit aL bL) (ListFixedLit aR bR) = align doc
  where
    doc =    format " " (diff aL aR)
          <> format " " (diffList bL bR)

diffPrimitiveExpression ListFixedFromList ListFixedFromList =
    "…"
diffPrimitiveExpression l@ListFixedFromList r =
    mismatch l r
diffPrimitiveExpression l r@ListFixedFromList =
    mismatch l r

diffPrimitiveExpression ListFixedToList ListFixedToList =
    "…"
diffPrimitiveExpression l@ListFixedToList r =
    mismatch l r
diffPrimitiveExpression l r@ListFixedToList =
    mismatch l r

diffPrimitiveExpression ListFixedHead ListFixedHead =
    "…"
diffPrimitiveExpression l@ListFixedHead r =
    mismatch l r
diffPrimitiveExpression l r@ListFixedHead =
    mismatch l r

diffPrimitiveExpression ListFixedTail ListFixedTail =
    "…"
diffPrimitiveExpression l@ListFixedTail r =
    mismatch l r
diffPrimitiveExpression l r@ListFixedTail =
    mismatch l r

diffPrimitiveExpression SymFromText SymFromText =
    "…"
diffPrimitiveExpression l@SymFromText r =
    mismatch l r
diffPrimitiveExpression l r@SymFromText =
    mismatch l r

diffPrimitiveExpression SymToText SymToText =
    "…"
diffPrimitiveExpression l@SymToText r =
    mismatch l r
diffPrimitiveExpression l r@SymToText =
    mismatch l r

diffPrimitiveExpression SSFromNonZero SSFromNonZero =
    "…"
diffPrimitiveExpression l@SSFromNonZero r =
    mismatch l r
diffPrimitiveExpression l r@SSFromNonZero =
    mismatch l r

diffPrimitiveExpression SSToNonZero SSToNonZero =
    "…"
diffPrimitiveExpression l@SSToNonZero r =
    mismatch l r
diffPrimitiveExpression l r@SSToNonZero =
    mismatch l r

diffPrimitiveExpression SSToNatural SSToNatural =
    "…"
diffPrimitiveExpression l@SSToNatural r =
    mismatch l r
diffPrimitiveExpression l r@SSToNatural =
    mismatch l r

diffPrimitiveExpression SSAdd SSAdd =
    "…"
diffPrimitiveExpression l@SSAdd r =
    mismatch l r
diffPrimitiveExpression l r@SSAdd =
    mismatch l r

diffPrimitiveExpression SSSubtract SSSubtract =
    "…"
diffPrimitiveExpression l@SSSubtract r =
    mismatch l r
diffPrimitiveExpression l r@SSSubtract =
    mismatch l r

diffPrimitiveExpression SSEqual SSEqual =
    "…"
diffPrimitiveExpression l@SSEqual r =
    mismatch l r
diffPrimitiveExpression l r@SSEqual =
    mismatch l r

diffPrimitiveExpression SSLessThan SSLessThan =
    "…"
diffPrimitiveExpression l@SSLessThan r =
    mismatch l r
diffPrimitiveExpression l r@SSLessThan =
    mismatch l r

diffPrimitiveExpression ProofToBool ProofToBool =
    "…"
diffPrimitiveExpression l@ProofToBool r =
    mismatch l r
diffPrimitiveExpression l r@ProofToBool =
    mismatch l r

diffPrimitiveExpression ProofFromBool ProofFromBool =
    "…"
diffPrimitiveExpression l@ProofFromBool r =
    mismatch l r
diffPrimitiveExpression l r@ProofFromBool =
    mismatch l r

diffPrimitiveExpression PVoid PVoid =
    "…"
diffPrimitiveExpression l@PVoid r =
    mismatch l r
diffPrimitiveExpression l r@PVoid =
    mismatch l r

diffPrimitiveExpression PVoidUndefined PVoidUndefined =
    "…"
diffPrimitiveExpression l@PVoidUndefined r =
    mismatch l r
diffPrimitiveExpression l r@PVoidUndefined =
    mismatch l r

diffPrimitiveExpression PVoidError PVoidError =
    "…"
diffPrimitiveExpression l@PVoidError r =
    mismatch l r
diffPrimitiveExpression l r@PVoidError =
    mismatch l r

diffPrimitiveExpression PVoidKindUndefined PVoidKindUndefined =
    "…"
diffPrimitiveExpression l@PVoidKindUndefined r =
    mismatch l r
diffPrimitiveExpression l r@PVoidKindUndefined =
    mismatch l r
...
diffPrimitiveExpression (Sym t) (Sym t') =
    diffText t t'
diffPrimitiveExpression l@Sym {} r =
    mismatch l r
diffPrimitiveExpression l r@Sym {} =
    mismatch l r

diffPrimitiveExpression SymLit {} SymLit {} =
    "…"
diffPrimitiveExpression l@(SymLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(SymLit {}) =
    mismatch l r

diffPrimitiveExpression SZ SZ =
    "…"
diffPrimitiveExpression l@SZ r =
    mismatch l r
diffPrimitiveExpression l r@SZ =
    mismatch l r

diffPrimitiveExpression SS {} SS {} =
    "…"
diffPrimitiveExpression l@SS{} r =
    mismatch l r
diffPrimitiveExpression l r@SS{} =
    mismatch l r

diffPrimitiveExpression SZLit {} SZLit {} =
    "…"
diffPrimitiveExpression l@(SZLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(SZLit {}) =
    mismatch l r

diffPrimitiveExpression (SSLit aL) (SSLit aR) =
    diffPrimitiveExpression aL aR
diffPrimitiveExpression l@(SSLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(SSLit {}) =
    mismatch l r

diffPrimitiveExpression Proof Proof =
    "…"
diffPrimitiveExpression l@Proof r =
    mismatch l r
diffPrimitiveExpression l r@Proof =
    mismatch l r

diffPrimitiveExpression ProofLit {} ProofLit {} =
    "…"
diffPrimitiveExpression l@(ProofLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(ProofLit {}) =
    mismatch l r
...
diffPrimitiveExpression (NonZeroLit aL) (NonZeroLit aR) =
    diffNonZero aL aR
diffPrimitiveExpression l@(NonZeroLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(NonZeroLit {}) =
    mismatch l r

diffPrimitiveExpression (DateTimeLit aL) (DateTimeLit aR) =
    diffDateTime aL aR
diffPrimitiveExpression l@(DateTimeLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(DateTimeLit {}) =
    mismatch l r

diffPrimitiveExpression (RegexLit aL) (RegexLit aR) =
    diffRegex aL aR
diffPrimitiveExpression l@(RegexLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(RegexLit {}) =
    mismatch l r

diffPrimitiveExpression (RationalLit aL) (RationalLit aR) =
    diffRational aL aR
diffPrimitiveExpression l@(RationalLit {}) r =
    mismatch l r
diffPrimitiveExpression l r@(RationalLit {}) =
    mismatch l r
